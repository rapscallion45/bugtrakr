...
const ConfirmDialog: React.FC<{
  ...
  actionFunc: () => void;
}> = function ConfirmDialog({ title, contentText, actionBtnText, triggerBtn, actionFunc }) {
  ...
  return (
    <div style={{ display: 'inline' }}>
      ...
      <Dialog open={dialogOpen} onClose={handleDialogOpen}>
        ...
        <DialogActions>
          <Button onClick={handleDialogClose} color="secondary" variant="contained" size="small">
            Cancel
          </Button>
